...
class EpicTaskTest {
    ...
    @Test
    @DisplayName("Установка конечного времени для эпика, когда одна подзадача ")
    ...
    public void shouldSetEpicStartTimeWhenAllSubtasksHaveStartTime() {
        assertEquals(subtaskOne.getStartTime(), epicTaskSecond.getStartTime());
    }
    ...
    public void shouldSetEpicEndTimeWhenAllSubtasksHaveEndTime() {
        assertEquals(subtaskSecond.getEndTime(), epicTaskSecond.getEndTime());
    }
